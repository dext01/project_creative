...
После запуска откроется дашборд (доступный также по ссылке https://yourcreative.streamlit.app/), где вы увидите:

    Панель настроек: Выбор ниши, трендов и загрузка файла.

    Карточки креативов: Лучшие сгенерированные объявления с метриками прогноза.

    Графики: Визуализация кликабельности по каналам.

    Экспорт: Кнопка скачивания готового campaign.json.
