...
После запуска откроется дашборд, где вы увидите:
1.  **Панель настроек:** Выбор ниши, трендов и загрузка файла.
2.  **Карточки креативов:** Лучшие сгенерированные объявления с метриками прогноза.
3.  **Графики:** Визуализация кликабельности по каналам.
4.  **Экспорт:** Кнопка скачивания готового `campaign.json`.
